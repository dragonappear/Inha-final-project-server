...
public class AuctionitemApiController {
    ...
    @ApiOperation(value = "경매아이템아이디로 가격 조회 API", notes = "경매아이템아이디로 가격 조회")
    ...
    @ApiOperation(value = "경매아이템아이디로 최저판매입찰금 조회 API", notes = "경매아이템아이디로 최저경매가격 조회")
    ...
    @ApiOperation(value = "아이템아이디로 판매입찰금 모두 조회 API", notes = "아이템 판매입찰금 모두 조회")
